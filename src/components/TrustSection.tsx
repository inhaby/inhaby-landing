...
import { Camera, ShieldCheck, Tag, ArrowRight, X, Check, MessageSquare, AlertCircle } from "lucide-react";
...
export default function TrustSection() {
  ...
  return (
    <section id="trust" className="py-24 bg-muted relative overflow-hidden">
      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        {/* Bento-style Feature Experience Cards */}
